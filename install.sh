...
REPO_URL="${AGENTKANBAN_REPO:-https://github.com/phoenixjyb/convergence-kanban.git}"
INSTALL_DIR="${AGENTKANBAN_INSTALL_DIR:-convergence-kanban}"
DEFAULT_PORT="${AGENTKANBAN_PORT:-8666}"
