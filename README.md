...
![Quick tour: board → bugs → analytics](docs/screenshots/tour.gif)
...
![Main board with expanded projects](docs/screenshots/board.png)
...
![Bug tracker — 7-status flow with manual + agent streams](docs/screenshots/bugs.png)
...
![Analytics — burndown, bug trends, workload, blocker aging](docs/screenshots/analytics.png)
